...
<body>
    <div class="container">
        <div class="row box-primary">
            <div class="col-md-4 col-md-offset-4 box1-a-dash" style="margin-top:20px;">
            ...
            <header>Student's Login</header>
                ...
                <h6>New User? <a href="studentregister" class="regi">Register Here</a></h6>
            </div>
        </div>
    </div>
