...
<div class="container">
        <div class="row box-primary">
            ...
            <hr>
            <header>Teacher Registration Page</header>
                <hr>
                <form action="{{route('register-teacher')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Expertise" name="expertise" value="{{old('expertise')}}">
                    </div>
                ...
                <h6>Registered Teacher?<a href="teacherlogin" class="regi"> Login Here</a></h6>
            </div>
        </div>
    </div>
